...
const tg36GeneralDescItems = [
  'מצב רוח נוח / מגיע בשמחה לגן / נפרד בקלות / משתף פעולה ברוב המטלות / בעל ויסות עצמי',
  'סובל משינויים קיצוניים במצב הרוח / מתקשה להיפרד בבוקר / מרבה לבכות / מוצץ אצבע או מוצץ / עקשן',
  'מפגין פחדים וחרדות מוגזמים / מתנהג בפסיביות / עצוב או מדוכדך רוב הזמן / מתבודד',
  'מגיב ברוגז / מתקשה לוותר / מגיב באלימות פיזית / אלימות מילולית / רב עם חבריו',
];
